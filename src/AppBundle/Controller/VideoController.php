...
class VideoController extends Controller
{
    ...
    public function addurlAction(Request $request)
    {
        ...
        return $this->render("AppBundle:Video:addurl.html.twig",array("form"=>$form->createView()));
    }
    ...
    public function editurlAction(Request $request,$id)
    {
        ...
        return $this->render("AppBundle:Video:editurl.html.twig",array("form"=>$form->createView()));    
    }
